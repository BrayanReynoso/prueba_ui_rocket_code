    ...
    <div class="container-fluid p-0">
      <div class="row m-0">
        <div class="col-12 px-3 py-3">
          ...
          >
            <div>
              ...
              <p class="text-muted mb-0">
                Administra el registro de estudiantes de la biblioteca
              </p>
            </div>
            <div>
              <button
          ...
          <div
            *ngIf="!loading && filteredStudents.length === 0"
          ...
          >
            ...
            <div>
              ...
              <p class="mb-0">
                Actualmente no hay estudiantes registrados o los filtros
                aplicados no arrojan resultados.
              </p>
              <button
                    ...
                    >
                      <td class="ps-3">
                        <div class="d-flex align-items-center">
                          <div
                            class="student-icon rounded-circle bg-light text-primary me-2 d-flex align-items-center justify-content-center"
                          >
          ...
          >
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <span class="badge bg-primary rounded-pill"
                >{{ filteredStudents.length }} estudiantes</span
              >
            </div>
          ...
          <div
            class="modal fade"
            [ngClass]="{ 'show d-block': showDeleteConfirm }"
            tabindex="-1"
            role="dialog"
          >
            <div class="modal-dialog" role="document">
    ...
    this.studentService.getAllStudents().subscribe({
      ...
      error: (err) => {
        ...
        this.alertService.error(
          "Error al cargar los estudiantes. Por favor, intente nuevamente más tarde."
        );
      },
    });
  }
        ...
        error: (err) => {
          ...
          if (err.message && err.message.includes("404")) {
            ...
            this.alertService.info(
              `No se encontró ningún estudiante con el correo "${this.searchTerm}"`
            );
          } else {
            this.alertService.error(
              err.message ||
    ...
    if (student.id) {
      this.studentService.updateStudent(student.id, student).subscribe({
        ...
        error: (err) => {
          ...
          this.alertService.error(
            err.message ||
              "Error al actualizar estudiante. Por favor, intente nuevamente."
          );
        },
      });
    } else {
    ...
    if (this.selectedStudent && this.selectedStudent.id) {
      this.studentService.deleteStudent(this.selectedStudent.id).subscribe({
        ...
        error: (err) => {
          ...
          this.alertService.error(
            err.message ||
              "Error al eliminar estudiante. Por favor, intente nuevamente."
          );
        },
      });
    }
