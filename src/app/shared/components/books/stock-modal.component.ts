      ...
      <div class="card mb-3 bg-light">
        <div class="card-body">
          ...
          <p class="mb-0">
            ...
            <span class="badge bg-primary">{{ book?.stock }}</span>
          </p>
        </div>
      </div>
      ...
      <form [formGroup]="stockForm" (ngSubmit)="onSubmit()">
        <div class="form-group mb-3">
          <label for="stock" class="form-label"
            >Cantidad a agregar al stock</label
          >
          ...
          <div
            *ngIf="
              stockForm.controls['stock'].invalid &&
              stockForm.controls['stock'].touched
            "
          ...
          >
            <span
              *ngIf="isLoading"
              ...
              aria-hidden="true"
            ></span>
            {{ isLoading ? "Procesando..." : "Agregar al Stock" }}
          </button>
        </div>
      </form>
    </div>
